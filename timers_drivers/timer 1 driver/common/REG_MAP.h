...
#define TCCR0          *((volatile u8*)0x53) //Timer/Counter0 Control Register | Controls mode, COM, prescaler, etc.
...
#define TCNT0          *((volatile u8*)0x52) // Timer/Counter0 Register | Holds current counter value
...
#define OCR0           *((volatile u8*)0x5C) // Output Compare Register0 | Holds compare value
...
#define TIMSK          *((volatile u8*)0x59) // Timer/Counter Interrupt Mask Register | Enables Timer0 interrupts
